...
<section id="main-wrapper">
    <div id="wrapper" class="container">
        <div id="common-about">
            <div class="content">
                <h1 class="ribbon">Wooden Bicycle</h1>
        ...
        <div id="common-productcategories">
            <div class="item active">
                <div class="outer">
                    <div class="inner">
                        <div><a href="index.php?cat=3">Wooden Bicycle</a></div>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="outer">
                    <div class="inner">
                        <div><a href="index.php?cat=4">Wooden Fashion</a></div>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="outer">
                    <div class="inner">
                        <div><a href="index.php?cat=5">Wooden Interior</a></div>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="outer">
                    <div class="inner">
                        <div><a href="index.php?cat=6">Wooden Toys</a></div>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="outer">
                    <div class="inner">
                        <div><a href="index.php?cat=7">Wooden Hobbies</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="common-content">
            <div class="main category">
                ...
                <div class="productgallery">
                    <div class="item">
                            <a href="index.php?p=1"><img src="<?php echo get_template_directory_uri() ?>/timthumb.php?src=img/dummy/photo-<?php echo rand(1,12) ?>.jpg&amp;w=300&amp;h=300" class="img-responsive" /></a>                        <div class="price">
                            <div class="row">
                                <div class="col-sm-6">
                                    Nama Produk
                                </div>
                    ...
                    <div class="item">
                        <a href="index.php?p=1"><img src="<?php echo get_template_directory_uri() ?>/timthumb.php?src=img/dummy/photo-<?php echo rand(1,12) ?>.jpg&amp;w=300&amp;h=300" class="img-responsive" /></a>
                        <div class="price">
                            <div class="row">
                                <div class="col-xs-6">
                                    Nama Produk
